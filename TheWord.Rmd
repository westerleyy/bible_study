...
```{r euclidean distance, echo=FALSE, fig.width=10, fig.height=8}
# # Distance
...
3. Cluster 2 and 5 are outliers.  
4. Cluster 4 is most probably an amalgamation of dissimilar chapters, given that most chapters are more different than they are similar, as the Euclidean distance plot suggests.  
